...
var pixels = [
    pixel(18, 10, .black), pixel(18, 10, .black), pixel(18, 11, .black),
    pixel(18, 12, .black), pixel(17, 13, .black), pixel(17, 14, .black),
    pixel(17, 14, .black), pixel(16, 15, .black), pixel(15, 16, .black),
    pixel(15, 16, .black), pixel(14, 17, .black), pixel(13, 17, .black),
    pixel(13, 17, .black), pixel(12, 18, .black), pixel(11, 18, .black),
    pixel(10, 18, .black), pixel(10, 18, .black), pixel(9, 18, .black),
    pixel(9, 18, .black), pixel(8, 18, .black), pixel(7, 17, .black),
    pixel(6, 17, .black), pixel(5, 16, .black), pixel(5, 16, .black),
    pixel(4, 15, .black), pixel(4, 15, .black), pixel(3, 14, .black),
    pixel(3, 13, .black), pixel(2, 12, .black), pixel(2, 12, .black),
    pixel(2, 11, .black), pixel(2, 10, .black), pixel(2, 10, .black),
    pixel(2, 9, .black), pixel(2, 8, .black), pixel(3, 7, .black),
    pixel(3, 6, .black), pixel(4, 5, .black), pixel(4, 5, .black),
    pixel(5, 4, .black), pixel(6, 3, .black), pixel(7, 3, .black),
    pixel(8, 2, .black), pixel(9, 2, .black), pixel(10, 2, .black),
    pixel(10, 2, .black), pixel(10, 2, .black), pixel(11, 2, .black),
    pixel(12, 2, .black), pixel(13, 3, .black), pixel(13, 3, .black),
    pixel(14, 3, .black), pixel(15, 4, .black), pixel(16, 5, .black),
    pixel(16, 5, .black), pixel(17, 6, .black), pixel(17, 7, .black),
    pixel(17, 7, .black), pixel(18, 8, .black), pixel(18, 9, .black),
    pixel(18, 10, .black)
]
/*:
