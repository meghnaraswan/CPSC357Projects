...
display.setPixel(x: 5, y: 2, color: .black )
/*:
 ...
 */
display.setPixel(x: 7, y: 7, color: Color(red: 37, green: 150, blue: 190))
display.setPixel(x: 6, y: 7, color: Color(hue: 194, saturation: 68, brightness: 45))
